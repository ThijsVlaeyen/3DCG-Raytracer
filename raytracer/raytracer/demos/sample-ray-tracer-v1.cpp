#include "demos/sample-ray-tracer-v1.h"
    ...
    protected:
        ...
        raytracer::Primitive create_root(TimeStamp now) override
        {
            ...
            MaterialProperties material_properties(
                0.1 * colors::red(),      // ambient lighting, not supported yet
                0.2 * colors::blue(),      // diffuse lighting, not supported yet
...
void demos::ray_tracer_v1(std::shared_ptr<pipeline::Consumer<std::shared_ptr<Bitmap>>> output)
{
    MeshDemo(500, 1_s, 15, 1).render(output);
}
