#pragma once
#include "demos/demoAndriesNoa.h"
...
namespace
{
    ...
    protected:
        ...
        raytracer::Primitive create_root(TimeStamp now) override
        {
            ...
            primitive1 = translate(Vector3D(x_position(now), 1, 0), primitive1);
...
void demos::demoAndriesNoa(std::shared_ptr<pipeline::Consumer<std::shared_ptr<Bitmap>>> output)
{
