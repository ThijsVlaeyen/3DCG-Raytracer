...
namespace
{
	...
	public:
		...
		{
			return Box(interval(-1.0, 1.0), interval(-1.0, 1.0), interval(-.01, .01));
		}
	...
	public:
		...
		Box bounding_box() const override
		{
			return Box(interval(-1.0, 1.0), interval(-.01, .01), interval(-1.0, 1.0));
		}
	...
	public:
		...
		Box bounding_box() const override
		{
			return Box(interval(-.01, .01), interval(-1.0, 1.0), interval(-1.0, 1.0));
		}
